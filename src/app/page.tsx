                        ...
                        <ul className="space-y-8">
                            ...
                            <li className="flex gap-4 items-start">
                                ...
                                <div>
                                    ...
                                    <p className="text-slate-400 text-sm font-medium mt-1 uppercase tracking-tight">பயிர் விலை, ஆர்டர் நிலை மற்றும் டெலிவரி புதுப்பிப்புகள் நிமஷங்களில் பெறுங்கள்.</p>
                                </div>
                            </li>
                            <li className="flex gap-4 items-start">
                                <div className="mt-1 p-1 bg-emerald-500/20 rounded-lg text-emerald-400"><Zap size={20} /></div>
